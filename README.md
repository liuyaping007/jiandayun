...
#### PC端设计
![PC端设计](https://oscimg.oschina.net/oscnet/up-03a37ba990272a03c333a6df9f3190799b4.png)  
**PC端预览**  
![PC端预览](https://oscimg.oschina.net/oscnet/up-807c0b90c6e5f7426d0ecdfdd26064ec392.png)

#### IDAD端设计
![IDAD端设计](https://oscimg.oschina.net/oscnet/up-d1f75bae1096060b6eba0e2224eada9232c.png)  
**IDAD端预览**  
![IDAD端预览](https://oscimg.oschina.net/oscnet/up-cf7bbbc9abf508e07c714446115a810f766.png)

#### 手机端设计
![手机端设计](https://oscimg.oschina.net/oscnet/up-5547906ea98c953f3b7cce836b1eaace0d9.png)  
**手机端预览**  
![手机端预览](https://oscimg.oschina.net/oscnet/up-850b67b070e3d92c02a96bef46b01447aae.png)
...
- **查看源码**：可在线编辑代码，添加函数，与设计生成代码进行融合。  
  ![JS部分](https://oscimg.oschina.net/oscnet/up-06a3e616ed876f70ea4de8601188493c1b9.png)

#### HTML部分
- **模板HTML**：支持在线编辑。  
  ![HTML部分](https://oscimg.oschina.net/oscnet/up-1bf3fb915cf8c1075db970e3981e438fe29.png)

#### CSS部分
- **界面风格调整**：可根据需求自行调整。  
  ![CSS部分](https://oscimg.oschina.net/oscnet/up-f585b9022d460f9a602ddd87b0bea7e5722.png)
#### 逻辑编排
- **逻辑编排**：主要是为了不懂程序开发人员轻松上手，也能快速配置一些复杂逻辑，实现各种功能。
  ![逻辑编排](public/8882df9e86f71c92da6d7a10a27490e4.png)
---
...
- **导出Vue源码**：直接拷贝到项目中即可使用，配置路由后即可访问。  
  ![导出Vue源码](https://oscimg.oschina.net/oscnet/up-a7886b8ee1945b0b6f6b92e4856fd8f5c76.png)
...
- **在线动态接口**：保存后即可生成增、删、查、导出、导入，列表查询，统计等动态接口，支持在线编辑修改。  
  ![动态接口](https://oscimg.oschina.net/oscnet/up-dcbef0b3cc67211b5b26bbf6946bc9a8dc1.png)
- 详细文档地址：【 [在线接口详细文档地址](http://doc.kyform.cn/pages/f8b0fc/)】

#### 接口功能
| 功能模块 | 描述 | 预览 |
|---------|------|------|
| **接口编辑** | 支持智能提示表名、表字段 | ![接口编辑](https://oscimg.oschina.net/oscnet/up-3a7a86178d54d6d29fb2e0a529f27d37e40.png) |
| **接口参数后端验证** | 支持参数验证 | ![参数验证](https://oscimg.oschina.net/oscnet/up-fb89d3ef582fa8cc84f36875e129a1b4db4.png) |
| **列表接口字段显示** | 支持字段显示配置 | ![字段显示](https://oscimg.oschina.net/oscnet/up-d9be34d94b03bccaadf97840a83d7a40ac7.png) |
| **接口在线测试** | 支持在线测试 | ![在线测试](https://oscimg.oschina.net/oscnet/up-0440ce3ad30d84fab9e15aba3f0d2bc075f.png) |
...
#### 表单设计器
![表单设计器](https://oscimg.oschina.net/oscnet/up-c0fd0a0ee2c7abdd0ff6c7d3f31385cfc52.png)

#### 流程发起
| 功能模块 | 预览 |
|---------|------|
| **流程信息** | ![流程信息](https://oscimg.oschina.net/oscnet/up-ea3510e28df6efb834fb07f6957f0478108.png) |
| **审批记录** | ![审批记录](https://oscimg.oschina.net/oscnet/up-10720a4757018cf193fe81aac3a3ac16a1c.png) |
| **流程走向** | ![流程走向](https://oscimg.oschina.net/oscnet/up-f3beb490f62be80e1d65d7e3498e31b3a1f.png) |

#### 手机端流程发起
| 功能模块 | 预览 |
|---------|------|
| **流程信息** | ![流程信息](https://oscimg.oschina.net/oscnet/up-d209fcb5a46ba98e96227e036048469d638.png) |
| **审批记录** | ![审批记录](https://oscimg.oschina.net/oscnet/up-6592df3b416cb4e38eb237b34d3dd29d0fe.png) |

---
### 打印设计器
#### 打印计器
![打印设计器](public%2Ff5d3b0d4-9bb6-4966-ab7a-2a2e64261845.png)
#### 打印效果
![打印设计器](public%2Fa744ea22-8f4b-4fd0-b4cc-17c618e6a97c.png)

### 集成&自动化
#### 集成&自动化计器
![打印设计器](public%2F01b82e60-c6cc-492d-8da8-e7045129b3fb.png)
#### 切换java源码
![打印设计器](public%2F6f631f0c-5847-479f-962c-f41daa7b914a.png)
#### 调试与测试
![打印设计器](public%2Fb31a943c-d3aa-4e72-9a6c-fff416870909.png)
...
| 微信 | QQ | QQ群 |
|------|----|------|
| <img src="https://oscimg.oschina.net/oscnet/up-582fc3f0b0152879dffdc0e9302b85e8a95.png" width="200" alt="微信"/> | <img src="https://oscimg.oschina.net/oscnet/up-933f0fcf9c91152aa625b06ee857f11d3f2.png" width="200" alt="QQ"/> | <img src="public/qq群.png" width="200" alt="QQ群"/> |
